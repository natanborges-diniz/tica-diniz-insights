// Clone 1:1 de pix-charges — publicado com nome novo para contornar artefato
// de deploy travado na plataforma (o nome antigo servia uma versão que caía no
// caminho REDE/payment-links e respondia /pay sem txid/copia-e-cola).
