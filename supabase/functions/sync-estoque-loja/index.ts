  ...
  try {
    ...
    const rows = comEstoque.map(i => {
      ...
      return {
        ...
        cod_barras_interno: i.codigo_barras ?? i.cod_barras_interno ?? null,
        ean: i.ean ?? null,
        ...
        preco_venda: toNum(i.preco_venda),
        data_ultima_compra: i.data_ultima_compra ?? null,
        data_ultima_entrada: i.data_ultima_entrada ?? null,
        data_ultima_venda: i.data_ultima_venda ?? null,
        dias_em_estoque,
        dias_desde_ultima_venda: dias_sem_venda,
        dias_giro_medio: toNum(i.dias_giro_medio),
        dias_giro_mediano: toNum(i.dias_giro_mediano),
        dias_giro_ultima_peca: toNum(i.dias_giro_ultima_peca),
        pecas_giro_consideradas: toInt(i.pecas_vendidas_consideradas),
