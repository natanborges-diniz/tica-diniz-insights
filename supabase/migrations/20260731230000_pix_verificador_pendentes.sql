-- ═══════════════════════════════════════════════════════════════════
-- Verificador automático de cobranças Pix pendentes.
-- Motivo: a confirmação era disparada apenas pela página /pix aberta
-- (polling do cliente). Quando o cliente paga pelo copia-e-cola direto
-- no app do banco, ninguém consulta o BTG e a loja não recebe a baixa.
-- Este cron chama pix-charges-v5 (action detalhe_publico — pública e
-- idempotente: verifica no BTG, confirma com guarda atômica, notifica
-- o Atrium/loja e trata expiração) para cada Pix ATIVO recente.
-- ═══════════════════════════════════════════════════════════════════
