-- Fix: fn_conciliar_extrato somava valor_pago de novo ao conciliar contra um
-- lançamento JÁ BAIXADO (caso novo do motor: títulos ERP pagos por fora do BTG
-- entram no pool de referência forte). valor_pago dobraria (ex.: 1500 → 3000).
-- Única mudança vs. 20260728225359: o SET de valor_pago no ramo LANCAMENTO
-- preserva o valor de quem já está BAIXADO.
